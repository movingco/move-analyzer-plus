...
Install on the VSCode Extension Marketplace: [Move Analyzer Plus on the VSCode Marketplace](https://marketplace.visualstudio.com/items?itemName=movingco.move-analyzer-plus)
